...
<head>
    ...
    <link rel="amphtml" href="httpa://weeklybiz.chosun.com/m/news/article.amp.html?contid=${ID}">
    ...
    <link rel="stylesheet" href="//weeklybiz.chosun.com/dhtm2019/css/weekly_article_style_webly.css">
...
<div id="csContent">
    <header class="news_title">
        ...
        <div class="news_pdf"><a href="#">pdf보기</a></div>
    ...
    <div class="sticky_wrapper" id="sticky_wrapper_id">
        ...
        <!-- CMT changed ver2 end / not use -->
            <div class="weekly_rec_wrap">
                ...
                <script>getRecommendList();</script>
                <!--weekly_rec end-->
            </div>
            <!-- weekly_rec_wrap end -->
...
<!-- TPL ver.New_20180913 -->
    ...
    <script type="text/javascript" src="//weeklybiz.chosun.com/dhtm2019/js/weekly_article_script_webly.js"></script>
</body>
</html>
